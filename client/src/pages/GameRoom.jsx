...
const GameRoom = () => {
  ...
  return (
    <div className="game-room-page" style={{ backgroundImage: `url(${bgGameRoom})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        {!gameStarted && (
          <div className="waiting-room">
            <div className="waiting-card">
              <h3>
                <img src={witchIcon} alt="witch" style={{ width: '100px', height: '100px', verticalAlign: 'middle', marginRight: '30px' }} />
                ...
                {players.map((player) => (
                  <div key={player.id} className="player-item">
                    <span className="player-name">
                      <img src={playerIcon} alt="player" style={{ width: '20px', height: '20px', verticalAlign: 'middle', marginRight: '6px' }} />
                      {player.name}
                    </span>
                ...
                <div className="host-controls">
                  <div className="setting-select">
                    ...
                    <div className="setting-display">
                      {selectedSetting === 'fantasy' && <img src={fantasyIcon} alt="fantasy" className="setting-icon" />}
                      {selectedSetting === 'sci-fi' && <img src={sciFiIcon} alt="sci-fi" className="setting-icon" />}
                      {selectedSetting === 'horror' && <img src={horrorIcon} alt="horror" className="setting-icon" />}
                      {selectedSetting === 'mystery' && <img src={mysteryIcon} alt="mystery" className="setting-icon" />}
                      <select
                      ...
                      >
                        ...
                        <option value="mystery">Mystery - Detective Tales</option>
                      </select>
                    </div>
                  </div>
                  <button
